...
where $1 \le l \le n$. There are $\binom{n-1}{l-1}$ ways to choose the remaining $l-1$ elements of the cycle and every such choice generates $\frac{l!}{l}$ different cycles.
...
=
\frac{1}{n!}
\sum_{l=1}^n \binom{n-1}{l-1} \; \frac{l!}{l} \; a_l \; (n-l)! \; Z(S_{n-l})
$$
